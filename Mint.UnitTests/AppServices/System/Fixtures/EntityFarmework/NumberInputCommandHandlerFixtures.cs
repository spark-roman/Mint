...
/// <summary>
/// Fixture for <see cref="Mint.App.Services.System.Bot.Handlers.Commands.NumberInputCommandHandler"/> tests with EF Core and DI.
/// </summary>
public sealed class NumberInputCommandHandlerFixtures : IDisposable
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="NumberInputCommandHandlerFixtures"/> class.
    /// </summary>
    public NumberInputCommandHandlerFixtures()
    {
        _databaseName = "TestDatabaseNumberInput" + Guid.NewGuid();
