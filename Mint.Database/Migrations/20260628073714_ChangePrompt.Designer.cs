...
namespace Mint.Database.Migrations
{
    ...
    [Migration("20260628073714_ChangePrompt")]
            ...
            modelBuilder.Entity("Mint.Database.Entities.System.AiPromptEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Temperature = 0.6f,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 6, 28, 7, 37, 13, 886, DateTimeKind.Unspecified).AddTicks(6545), new TimeSpan(0, 0, 0, 0, 0)),
