...
namespace Mint.Database.Migrations
{
    ...
    [Migration("20260725080752_RenameCode")]
            ...
            modelBuilder.Entity("Mint.Database.Entities.System.AiPromptEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Temperature = 0.6f,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(2063), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Mint.Database.Entities.UserInteractive.Bonuses.BonusTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "start",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1833), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за первую регистрацию в боте",
                            IsActive = true,
                            Name = "Стартовый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1833), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Code = "daily",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1835), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за ежедневный вход в бот",
                            IsActive = true,
                            Name = "Ежедневный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1835), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            Code = "streak",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1836), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Дополнительный бонус за непрерывный стрик 7+ дней",
                            IsActive = true,
                            Name = "Бонус за стрик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1837), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            Code = "referral",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1838), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за приведённого друга",
                            IsActive = true,
                            Name = "Реферальный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1838), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            Code = "rating",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1840), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус по итогам голосования",
                            IsActive = true,
                            Name = "Рейтинговый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1840), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 6,
                            Code = "admin",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1841), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Ручное начисление администратором",
                            IsActive = true,
                            Name = "Административный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 25, 8, 7, 51, 573, DateTimeKind.Unspecified).AddTicks(1842), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
