...
namespace Mint.Database.Migrations
{
    ...
    [Migration("20260905184546_ChangeMoneyFormat")]
    partial class ChangeMoneyFormat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mint.Database.Entities.News.NewsEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("CategoryCode", "IsProcessed")
            ...
            modelBuilder.Entity("Mint.Database.Entities.News.RSS.RssSourceEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("rss_sources");
                });

            modelBuilder.Entity("Mint.Database.Entities.Prompts.System.AiPromptEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Temperature = 0.6f,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1774), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Mint.Database.Entities.System.Payouts.PayoutEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("DuelId", "Status")
                        .HasDatabaseName("idx_payouts_duel_status");

                    b.ToTable("payouts");
                });

            modelBuilder.Entity("Mint.Database.Entities.System.Settings.SystemSettingEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Key = "StartBonus",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2149), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "5000"
                        },
                        new
                        {
                            ...
                            Key = "DailyBonus",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2151), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "1000"
                        },
                        new
                        {
                            ...
                            Key = "StreakBonus",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2152), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "10000"
                        },
                        new
                        {
                            ...
                            Key = "HouseCommission",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2153), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "0.05"
                        },
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2154), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "24"
                        },
                        new
                        {
                            ...
                            Key = "LeaderboardSize",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2155), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "15"
                        },
                        new
                        {
                            ...
                            Key = "MaxBetPercent",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2156), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "100"
                        },
                        new
                        {
                            ...
                            Key = "ReferralBonus",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2157), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "5000"
                        },
                        new
                        {
                            ...
                            Key = "MinBetAmount",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(2158), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "10"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Mint.Database.Entities.UserInteractive.Bonuses.BonusTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "start",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1546), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за первую регистрацию в боте",
                            IsActive = true,
                            Name = "Стартовый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1546), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Code = "daily",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1548), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за ежедневный вход в бот",
                            IsActive = true,
                            Name = "Ежедневный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1548), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            Code = "streak",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1550), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Дополнительный бонус за непрерывный стрик 7+ дней",
                            IsActive = true,
                            Name = "Бонус за стрик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1550), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            Code = "referral",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1552), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за приведённого друга",
                            IsActive = true,
                            Name = "Реферальный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1552), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            Code = "rating",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1554), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус по итогам голосования",
                            IsActive = true,
                            Name = "Рейтинговый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1554), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 6,
                            Code = "admin",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1555), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Ручное начисление администратором",
                            IsActive = true,
                            Name = "Административный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 9, 5, 18, 45, 45, 604, DateTimeKind.Unspecified).AddTicks(1556), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("Mint.Database.Entities.News.NewsEntity", b =>
                {
                    b.HasOne("Mint.Database.Entities.News.RSS.RssSourceEntity", "RssSource")
                        .WithMany("News")
            ...
            modelBuilder.Entity("Mint.Database.Entities.System.Payouts.PayoutEntity", b =>
                {
                    ...
                    b.HasOne("Mint.Database.Entities.Ledger.Transactions.TransactionEntity", "Transaction")
                        .WithMany()
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Mint.Database.Entities.UserInteractive.Votes.VoteEntity", "Vote")
                        .WithMany()
            ...
            modelBuilder.Entity("Mint.Database.Entities.UserInteractive.UserCategories.CategoryEntity", b =>
                {
                    b.HasOne("Mint.Database.Entities.Prompts.System.AiPromptEntity", "AiPrompt")
                        .WithMany("Categories")
