...
namespace Mint.Database.Migrations
{
    ...
    [Migration("20260810191046_AddSystemSettings")]
            ...
            modelBuilder.Entity("Mint.Database.Entities.Prompts.System.AiPromptEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Temperature = 0.6f,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1858), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Mint.Database.Entities.System.Settings.SystemSettingEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Key = "StartBonus",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2277), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "5000"
                        },
                        new
                        {
                            ...
                            Key = "DailyBonus",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2285), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "1000"
                        },
                        new
                        {
                            ...
                            Key = "StreakBonus",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2286), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "10000"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2287), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "24"
                        },
                        new
                        {
                            ...
                            Key = "LeaderboardSize",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2288), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "15"
                        },
                        new
                        {
                            ...
                            Key = "MaxBetPercent",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2289), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "100"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Key = "MinBetAmount",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2292), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "10"
                        },
                        new
                        {
                            ...
                            Key = "MaxBetAmount",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(2293), new TimeSpan(0, 0, 0, 0, 0)),
                            Value = "10000"
                        });
                });
            ...
            modelBuilder.Entity("Mint.Database.Entities.UserInteractive.Bonuses.BonusTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "start",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1660), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за первую регистрацию в боте",
                            IsActive = true,
                            Name = "Стартовый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1660), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Code = "daily",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1662), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за ежедневный вход в бот",
                            IsActive = true,
                            Name = "Ежедневный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1662), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            Code = "streak",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1664), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Дополнительный бонус за непрерывный стрик 7+ дней",
                            IsActive = true,
                            Name = "Бонус за стрик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1664), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            Code = "referral",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1665), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за приведённого друга",
                            IsActive = true,
                            Name = "Реферальный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1666), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            Code = "rating",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1668), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус по итогам голосования",
                            IsActive = true,
                            Name = "Рейтинговый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1668), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 6,
                            Code = "admin",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1670), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Ручное начисление администратором",
                            IsActive = true,
                            Name = "Административный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 8, 10, 19, 10, 45, 837, DateTimeKind.Unspecified).AddTicks(1670), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
