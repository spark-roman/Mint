...
namespace Mint.Database.Migrations
{
    ...
    [Migration("20260715165932_AddDuels")]
            ...
            modelBuilder.Entity("Mint.Database.Entities.System.AiPromptEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Temperature = 0.6f,
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(739), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Mint.Database.Entities.UserInteractive.Bonuses.BonusTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "start",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(462), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за первую регистрацию в боте",
                            IsActive = true,
                            Name = "Стартовый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(463), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 2,
                            Code = "daily",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(464), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за ежедневный вход в бот",
                            IsActive = true,
                            Name = "Ежедневный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(465), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 3,
                            Code = "streak",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(466), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Дополнительный бонус за непрерывный стрик 7+ дней",
                            IsActive = true,
                            Name = "Бонус за стрик",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(467), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 4,
                            Code = "referral",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(468), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус за приведённого друга",
                            IsActive = true,
                            Name = "Реферальный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(468), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 5,
                            Code = "rating",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(470), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Бонус по итогам голосования",
                            IsActive = true,
                            Name = "Рейтинговый бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(470), new TimeSpan(0, 0, 0, 0, 0))
                        },
                        new
                        {
                            Id = 6,
                            Code = "admin",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(471), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Ручное начисление администратором",
                            IsActive = true,
                            Name = "Административный бонус",
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 7, 15, 16, 59, 32, 428, DateTimeKind.Unspecified).AddTicks(471), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
